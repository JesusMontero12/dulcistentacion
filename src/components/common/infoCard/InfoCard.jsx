        ...
        <div className="container">
          <div className="row text-center g-4">
            <div className="col-md-4">
              ...
              <p className="section-text mb-1">Lun - Sáb: 10:00 - 21:00</p>
              <p className="section-text">Dom: Cerrado.</p>
            </div>
            ...
            <div className="col-md-4">
              ...
              <p className="section-text mb-1">Chile.</p>
              <Link
                target="blank"
